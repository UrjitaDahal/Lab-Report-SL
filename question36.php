    ...
    <div class="container"> 
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            ...
            <div class="flex"> 
                ...
                <input type="number" id="monthly_salary" name="monthly_salary" value="<?php echo htmlspecialchars($monthlySalary); ?>"><br><br> 
            </div> 
            <h3>Annual Income</h3> 
            <div class="flex"> 
                <label for="annual_income">Annual Gross Salary:</label> 
                <input type="number" id="annual_income" name="annualincome" value="<?php echo htmlspecialchars($annual_income); ?>"><br><br>  
            </div> 
            <div class="flex"> 
                <input type="reset" value="Clear Inputs" class="btn-reset"> 
